...
export default function How_It_Work() {
  return (
    ...
    <div className=" gap-6 max-w-5xl mx-auto mt-8 p-6 md:grid-cols-2  md:w-4/5  justify-center items-center grid-row-2 grid">
          {/* Grid Start */}
          ...
          <div className="poppins grid grid-rows-subgrid col-span-1 justify-center items-center md:text-justify text-center">
              {/* Arrow */}
              <div className="md:w-20 md:h-20 w-16 h-16 mb-2 rotate-90 md:-mt-80 -mt-28 md:-rotate-12  ">
                <Arrow />
              </div>
            <div className="">
              <h2 className="md:text-2xl bg-clip-text text-transparent bg-custom-gradient font-bold">
                STEP 01
              </h2>
              <p className="md:text-3xl text-xl poppins py-2">
                Upload Your Resume
              </p>
              <p className="text-xs md:text-lg md:font-medium font-normal">
          ...
          <div className="relative md:order-3 poppins grid grid-rows-subgrid col-span-1 justify-center items-center md:text-justify text-center">
            ...
            <div>
              ...
              <div className="flex md:flex-row flex-col justify-between">
                <p className="md:text-3xl text-xl order-1 poppins py-2 ">
                    Automatic Analysis
                </p>
                    <div className="md:order-2 md:rotate-0  w-16 h-16 -rotate-45 ">
                    <Arrow2/>
                </div>
          ...
          <div className="order-6 poppins grid grid-rows-subgrid col-span-1 justify-center items-center md:text-justify text-center">
            <div>
              <h2 className="md:text-2xl bg-clip-text text-transparent bg-custom-gradient font-bold">
                STEP 03
              </h2>
