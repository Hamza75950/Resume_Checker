...
export default function Waitlist() {
  return (
    <div className="p-5">
      <div className="md:max-w-md xl:max-w-full mx-auto mb-2">
      ...
      <div className="poppin text-sm border rounded-sm max-w-xl xl:max-w-6xl md:p-10 p-5 mx-auto">
        <form
          action=""
          className="grid md:grid-cols-2 gap-2 xl:gap-8 md:text-md  text-xs "
        >
          <input
            type="text"
            className="border  p-2 xl:p-6 rounded-full "
            value="First Name"
          />
          <input
            type="text"
      ...
      <div className="flex justify-center items-start md:my-4 xl:my-10 my-2">
